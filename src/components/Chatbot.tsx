...
//     // Strip markdown markers for a clean clipboard copy
...
//   /**
//    * Enhanced formatter to handle Bold (**), Bullets (*),
...
//       // Detect and style bullet points
//       const isBullet =
...
//         // Nested parsing for Links, Emails, and Phone Numbers
...
//             );
//           }
//           return subPart.split(emailRegex).map((emailPart, k) => {
...
//               );
//             }
//             return emailPart.split(phoneRegex).map((phonePart, l) => {
...
//       >
//         {isOpen ? <IconClose size={28} /> : <IconMessage size={28} />}
//       </motion.button> */}
...
//                 >
//                   <div
//                     className={`group relative max-w-[90%] text-sm p-3 rounded-2xl shadow-sm leading-relaxed ${
//                       msg.role === "user"
